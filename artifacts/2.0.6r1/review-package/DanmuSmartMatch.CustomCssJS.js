 ...
 * 适用于 Emby 4.9.x + 本方案配套的 Emby.Plugin.Danmu 2.0.6r1 DLL
 */
(function () {
    "use strict";

    // V30 owns Android command back while retaining the V22 mapping contract.
    var INSTALL_FLAG = "__embyDanmuSmartMenuV30";
