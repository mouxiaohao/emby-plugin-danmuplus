 ...
 * 适用于 Emby 4.9.x + 本方案配套的 Emby.Plugin.Danmu 2.0.3r5 DLL
 */
(function () {
    "use strict";

    // V21 fences exact target-Season scope plans from cached r4/V20 drafts.
    var INSTALL_FLAG = "__embyDanmuSmartMenuV21";
