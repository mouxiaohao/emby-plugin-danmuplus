 ...
 * 适用于 Emby 4.9.x + 本方案配套的 Emby.Plugin.Danmu 2.0.3r4 DLL
 */
(function () {
    "use strict";

    // V20 fences parent-season-aware plans from cached r3 browser drafts.
    var INSTALL_FLAG = "__embyDanmuSmartMenuV20";
    var MAPPING_PROTOCOL_VERSION = 20;
    ...
    function seasonPlanGeneration(season) {
        ...
        return generation === null || generation === undefined || generation === "" ? null : generation;
    }
    ...
    function renderCompositeGroupPicker(dialog, item, season, seasonIndex, seasons, selections, keywords, group, options) {
        ...
        async function searchCurrentGroup(isAutomatic) {
            ...
            try {
                ...
                season.Message = "临时季搜索失败，可重试：" + publicErrorMessage(error);
                renderCompositeGroupPicker(dialog, item, season, seasonIndex, seasons, selections, keywords, group,
                    { skipAutomaticRangeSearch: true });
