 ...
 * 适用于 Emby 4.9.x + 本方案配套的 Emby.Plugin.Danmu 2.0.3r6 DLL
 */
(function () {
    "use strict";

    // V22 refreshes the installed UI while retaining the V21 mapping contract.
    var INSTALL_FLAG = "__embyDanmuSmartMenuV22";
    ...
    function setBusy(dialog, message, search) {
        ...
        if (!dialog.forceRefreshLocked) appendPreDownloadFooter(dialog);
        if (search) {
