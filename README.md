...
Emby 弹幕插件增强版，参考 [fengymi/emby-plugin-danmu](https://github.com/fengymi/emby-plugin-danmu) 开发。当前版本为 **2.0.7r2**，面向 Synology 套件版 Emby **4.9.5.0**；V22/V34 保持协议兼容并完成本地确定性验证。
