...
namespace Emby.Plugin.Danmu.Configuration
{
    public class PluginConfiguration : BasePluginConfiguration
    {
        ...
        /// 版本信息
        /// </summary>
        public string Version { get; } = "2.0.3r10";//Assembly.GetExecutingAssembly().GetName().Version.ToString();
    ...
    public class DandanOption
    {
        ...
        /// <summary>
        /// Null preserves the legacy migration state; explicit values record the user's selection.
        /// </summary>
        public bool? UseOfficialProxyCors { get; set; }
        ...
        /// <summary>
        /// Dandanplay Open API application secret.
        /// </summary>
