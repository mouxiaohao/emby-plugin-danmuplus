    ...
    internal static class Program
    {
        ...
        private static void VerifiesVersionedConfigurationPageResources()
        {
            ...
            Assert(assembly.GetName().Version?.ToString() == "2.0.7.0" &&
                   fileVersion == "2.0.7.3" && informationalVersion == "2.0.7r3" &&
                   new PluginConfiguration().Version == "2.0.7r3" && token == "2-0-7r3",
                "the 2.0.7r3 assembly, file, product/configuration, and cache identities must remain exact");
