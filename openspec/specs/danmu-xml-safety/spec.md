# Danmu XML Safety Specification

## Purpose

Defines provider-input recovery, shared XML output safety, and semantic validation so legal danmu content remains downloadable even when upstream data includes XML 1.0-invalid values.
