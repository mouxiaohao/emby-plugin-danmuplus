...
- [ ] 18.4 After explicit authorization for this new artifact, back up the currently deployed pair, deploy and read back the verified DLL, and live-preview `妄想学生会` Season 2 without initiating a download; verify the starred candidate receives 100 while the markerless candidate remains 80.
