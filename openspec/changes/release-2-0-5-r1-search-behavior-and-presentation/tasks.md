...
- [ ] 18.3 Run TitleFidelity, TMDB alias, SearchTermPolicy, R3 search quality, complete backend regression, sequential Release build, strict OpenSpec validation, diff/scope/credential checks, and Sol-high final review; record the new independently revertible commit and artifact hash without claiming deployment.
