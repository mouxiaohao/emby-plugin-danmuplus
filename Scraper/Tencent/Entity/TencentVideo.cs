...
namespace Emby.Plugin.Danmu.Scraper.Tencent.Entity
{
    public class TencentVideo
    {
        ...
        [DataMember(Name="videoDoc")] public TencentVideoDoc VideoDoc { get; set; }
        [DataMember(Name="playSites")] public List<TencentPlaySite> PlaySites { get; set; }
    ...
    {
        [DataMember(Name="uploader")] public string Uploader { get; set; }
    }

    public class TencentPlaySite
    {
        [DataMember(Name="enName")] public string EnName { get; set; }
    }
}
